...
#         instance = CeleryClient()
#         response = instance.active_queues()
#         return render('monitor/queues_configuration.html', locals())
#
#     def post(self,request):
#         pass
#
...
#         instance = CeleryClient()
#         response = instance.registered_tasks()
#         return render(request, 'monitor/registered_tasks.html')
#
#
...
#         title = 'Active Tasks'
#         action = 'terminate'
#         return render(request, 'monitor/active_tasks.html')
#
#
# class ReservedTasksView(LoginRequiredMixin, View):
#     def get(self, request):
#         instance = CeleryClient()
#         tasks = instance.reserved_tasks()
#         title = 'Reserved Tasks'
#         action = 'revoke'
#         return render(request, 'monitor/active_tasks.html', {"tasks": tasks})
#
#
...
#         return render(request, 'monitor/task_configuration.html')
#
#
...
#         return render(request, 'monitor/worker_status.html')
#
#
...
#         instance = CeleryClient()
#         stats = instance.worker_stats
#         return render(request, 'monitor/pool_configuration.html')
#
#
...
#         return render('monitor/taskstatechart.html',locals())